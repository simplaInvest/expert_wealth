...
st.set_page_config(page_title="Time Bulls", page_icon="🐂", layout="wide")
...
if st.session_state.user_type == "admin" or (st.session_state.user_type == "líder" and st.session_state.team == "time_bulls"):
    ...
    with col2:
        st.image("time_bulls.png", use_container_width=True)


    # Conteúdo da página
    st.title("Painel do Time Bulls")
    st.write("Bem-vindo à página do Time Fênix, Gustavo.")
...
with cols_filters[1]:
    sdrs_dict = {
        '2023 (3231420106 - Melissa)': 'Melissa',
